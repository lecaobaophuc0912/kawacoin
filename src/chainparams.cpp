...
{
    const char* pszTimestamp = "Fortune 03/Jan/2024 Kwa was born from HCMC";
...
public:
    ...
    //    return;
       ...
       /////////////////////////////////////////////////////////////////
        ...
        genesis = CreateGenesisBlock(nGenesisTime, 9069401, 0x1e00ffff, 2, 5000 * COIN);;

        consensus.hashGenesisBlock = genesis.GetX16RHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000011b623e0347b49d428bc2263eb687785c1f921b73693f25c2ed09dbbf8"));
        assert(genesis.hashMerkleRoot == uint256S("556aed939bf8dab0591884b0fd0194458a9dbf877bebfc0936612bd9d79f2728"));
        // vSeeds.clear();
        // vSeeds.emplace_back("10.11.11.105", false);
        // vSeeds.emplace_back("138.201.21.199", false);
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x52, 0x41, 0x56, 0x41};
        base58Prefixes[EXT_SECRET_KEY] = {0x52, 0x41, 0x56, 0x41};

        // Raven BIP44 cointype in mainnet is '172'
        nExtCoinType = 172;
        ...
        chainTxData = ChainTxData{
            ...
            1704273828, // * UNIX timestamp of last known number of transactions
            3000,    // * total number of transactions between genesis and that timestamp
